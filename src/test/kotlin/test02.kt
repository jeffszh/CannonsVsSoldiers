...
fun main() {
	...
	val txt1 = gson.toJson(msg1)
	println(txt1)
	val msg2 = gson.fromJson(txt1, GameMessage::class.java)
	val txt2 = gson.toJson(msg2)
	println(txt2)
	val msg3 = GameMessage(NetGameState.LOCAL_TURN, "222", "333")
	val txt3 = gson.toJson(msg3)
	println(txt3)
